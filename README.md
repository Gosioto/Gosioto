...
<details>
<summary><b>📈 2025 - IT-компетенции</b></summary>

- 🎓 Саморазвитие и подтверждение навыков на ГосУслугах
- 📚 Изучение продвинутых паттернов проектирования
- 🏆 Получение сертификатов гос. образца
- 🌟 Создание портфолио с лучшими работами

**Навыки:** HTML+CSS 95%, JS 85%, Node 50%
</details>

<details>
<summary><b>💻 2024-25 - Личные проекты & Legacy</b></summary>

- ⚛️ SPA на React + Vite, SSR-эксперименты на Next.js
- 🤖 Telegram-боты на Node.js
- 🔄 Рефакторинг устаревшего кода без потери функциональности
- ⚡ Ускорение работы приложений в 2-3 раза

**Навыки:** React 70%, Node.js 65%, VanillaJS 85%, Legacy 65%
</details>

<details>
<summary><b>🌐 2022-24 - Full-stack Developer</b></summary>
...
**Навыки:** Vue 55%, Python 75%, HTML/CSS 75%
</details>

<details>
<summary><b>💼 2021-23 - Фриланс-разработчик</b></summary>

- 📱 Адаптивные интерфейсы, API, оптимизация
- ⏰ Соблюдение сроков при ограниченных ресурсах
- 🤝 Построение долгосрочных отношений с клиентами
- ⭐ Получение рейтинга 5 звезд на фриланс-платформах

**Навыки:** Python 40%, JS+HTML+CSS 35%, SQL 35%
</details>
...
[![Демо](https://img.shields.io/badge/Демо-000000?style=for-the-badge&logo=play&logoColor=white)](https://gosioto.github.io/SKYT/index.html)

### 🎮 **Пиксельная Экосистема**
> Полный рефакторинг игры с React (3000+ строк) на чистый Vanilla JS. Уменьшение размера бандла на 85%, ускорение первой отрисовки на 40%.

- 🧠 **Особенности:** Архитектура «Entity–Component–System», анимация через requestAnimationFrame
- 🛠️ **Технологии:** JavaScript ES6+, Canvas 2D API, Web Workers
- 🎯 **Результат:** Уменьшение размера бандла на 85%, ускорение на 40%

[![Запустить симуляцию](https://img.shields.io/badge/Запустить_симуляцию-FF6B6B?style=for-the-badge&logo=gamepad2&logoColor=white)](https://gosioto.github.io/index.html#pixel-ecosystem-game)
...
[![Проект](https://img.shields.io/badge/Проект-4ECDC4?style=for-the-badge&logo=shield&logoColor=white)](https://gosioto.github.io/sentinelguard/index.html)
...
> *"Увлечения — это топливо для креативности. Каждое мое хобби привносит что-то новое в мою работу как разработчика."*
...
![GitHub Stats](https://github-readme-stats.vercel.app/api?username=Gosioto&show_icons=true&theme=tokyonight&hide_border=true&count_private=true)

![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=Gosioto&layout=compact&theme=tokyonight&hide_border=true)

![GitHub Streak](https://github-readme-streak-stats.herokuapp.com/?user=Gosioto&theme=tokyonight&hide_border=true)
